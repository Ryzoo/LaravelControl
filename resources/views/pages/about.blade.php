    ...
    <div class="container about-content">
        <div class="row">
            <div class="col m12 l6">
                ...
                <p style="font-size: 25px; font-weight: lighter">{{__('Manage, deploy and monitor all your Laravel-based applications in real time using our product.')}}</p>
                <div>
                    <a style="font-size: 22px" class="waves-effect waves-light red lighten-1 btn" href="#soon">{{__('Use Free')}}</a>
                    <a style="font-size: 22px" class="waves-effect waves-light waves-red btn-flat" href="#about">{{__('Learn more')}} ></a>
                </div>
            </div>
        </div>
    </div>
